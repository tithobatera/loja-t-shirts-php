                ...
                <nav class="py-3 justify-content-center position-fixed w-100" style="top: 0; left: 0; background-color: white; z-index: 1030;">
                    <ul class="nav nav-pills justify-content-center">
                        ...
                        <div class="dropdown">
                            ...
                            <form class="dropdown-menu p-4" method="POST" action="login.php">
                                <div class="mb-3">
                                    <label for="exampleDropdownFormEmail2" class="form-label">Email</label>
                                    <input type="email" class="form-control" name="email" id="exampleDropdownFormEmail2" placeholder="email" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleDropdownFormPassword2" class="form-label">Senha</label>
                                    <input type="password" class="form-control" name="senha" id="exampleDropdownFormPassword2" placeholder="Senha" required>
                                </div>
...
<div class="banner">
    <video autoplay loop muted>
        <source src="videos/Kvell Apparel Co. - Clothing Brand Promo Video.mp4" type="video/mp4">
        Seu navegador não suporta vídeos.
    </video>
    <!-- Título centralizado no banner -->
    <h1 class="banner-title">T N Shirt's</h1>
</div>



<div class="gallery">
    <img src="imagens/galeria index/06609279001-c.jpg" alt="Imagem 1" class="fade-in">
    <img src="imagens/galeria index/6b2431341e80fa899d5c73d817b16e8c.jpg" alt="Imagem 2" class="fade-in">
    <img src="imagens/galeria index/e0a4d2ceff4865b96789b51deabd0967.jpg" alt="Imagem 3" class="fade-in">
    <img src="imagens/galeria index/e43cc9b9-34fe-4bff-b2d2-30df0a668ae9.jpg" alt="Imagem 4" class="fade-in">
    <img src="imagens/galeria index/5.jpg" alt="" class="fade-in">
    <img src="imagens/galeria index/6.jpg" alt="" class="fade-in">
    <img src="imagens/galeria index/7.jpg" alt="" class="fade-in">
    <img src="imagens/galeria index/8.jpg" alt="" class="fade-in">
...
<div class="container">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top" style="background-color: transparent;">
...
<script>
    ...
    // Função para revelar imagens quando aparecem na viewport
